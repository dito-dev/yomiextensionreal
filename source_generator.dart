...
List<Source> _searchJsSources(Directory dir) {
  ...
  for (FileSystemEntity entity in entities) {
    if (entity is Directory) {
      if (entity.path.contains('not_working') || entity.path.contains('deprecated')) {
        continue;
      }
      ...
      if (match != null) {
        for (var sourceJson in jsonDecode(match.group(1)!) as List) {
          ...
          Source source = Source.fromJson(sourceJson)
            ...
            ..sourceCodeUrl =
                "https://raw.githubusercontent.com/dito-dev/yomiextensionreal/main/${sourceJson["pkgPath"] ?? sourceJson["pkgName"]}";
